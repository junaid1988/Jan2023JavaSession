...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println(s.indexOf('i'));// 1st occurrence i
		System.out.println(s.indexOf('i', s.indexOf('i')+1));//2nd occurrence i
		...
		System.out.println(test.trim());//trim() will remove before/after spaces
		...
		//
		String empInfo = "Katie|seiwer|LA|USA|apple|sdet";
