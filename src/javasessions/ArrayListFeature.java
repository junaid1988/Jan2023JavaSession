...
public class ArrayListFeature {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> empList = new ArrayList<String>(Arrays.asList("Tom", "Azam", "Amit", "Pooja"));
		...
		empList.add(3, "Rajesh");//IndexOutOfBoundsException
		System.out.println(empList);
		...
		ArrayList<String> countries = new ArrayList<String>(Collections.nCopies(10, "Kabul"));
