...
public class Shopping {
	...
	public void booking(String carType, String fromLocation, String toLocation, int pssg) {

	}

	public void booking(String carType, String fromLocation, String toLocation, int psg, String paymentOption) {
